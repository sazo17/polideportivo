...
CREATE TABLE IF NOT EXISTS `p_polideportivo`.`JUGADORES` (
  ...
  `POSICION_JUGADOR_id_pogjug` INT NOT NULL,
  PRIMARY KEY (`idJugadores`, `POSICION_JUGADOR_id_pogjug`),
  INDEX `fk_JUGADORES_POSICION_JUGADOR1_idx` (`POSICION_JUGADOR_id_pogjug` ASC),
  CONSTRAINT `fk_JUGADORES_POSICION_JUGADOR1`
    FOREIGN KEY (`POSICION_JUGADOR_id_pogjug`)
...
CREATE TABLE IF NOT EXISTS `p_polideportivo`.`UNIFORME` (
  ...
  `visita_color_uniforme` VARCHAR(15) NULL,
...
CREATE TABLE IF NOT EXISTS `p_polideportivo`.`JORNADAS` (
  ...
  `idTipo_Deporte` INT NOT NULL,
  `C_idDeporte` INT NOT NULL,
  `idTipo_campeonato` INT NOT NULL,
  `idEstado_partido` INT NOT NULL,
  PRIMARY KEY (`idJornadas`, `idEquipos_local`, `idEquipos_visita`, `idCampeonato`, `idTipo_Deporte`, `C_idDeporte`, `idTipo_campeonato`),
  INDEX `fk_Jornadas_Arbitro1_idx` (`idArbitro` ASC, `A_idDeporte` ASC, `idTipo_Arbitro` ASC),
  ...
  INDEX `fk_JORNADAS_CAMPEONATO1_idx` (`idCampeonato` ASC, `idTipo_Deporte` ASC, `C_idDeporte` ASC, `idTipo_campeonato` ASC),
  INDEX `fk_JORNADAS_ESTADO_PARTIDO1_idx` (`idEstado_partido` ASC),
  CONSTRAINT `fk_Jornadas_Arbitro1`
    FOREIGN KEY (`idArbitro` , `A_idDeporte` , `idTipo_Arbitro`)
  ...
  CONSTRAINT `fk_JORNADAS_CAMPEONATO1`
    FOREIGN KEY (`idCampeonato` , `idTipo_Deporte` , `C_idDeporte` , `idTipo_campeonato`)
...
CREATE TABLE IF NOT EXISTS `p_polideportivo`.`ANOTACIONES_REGISTRO_JUGADORES` (
  ...
  CONSTRAINT `fk_ANOTACIONES_REGISTRO_JUGADORES_JORNADAS1`
    ...
    REFERENCES `p_polideportivo`.`JORNADAS` (`idJornadas` , `idEquipos_local` , `idEquipos_visita` , `idCampeonato` , `idTipo_Deporte` , `C_idDeporte` , `idTipo_campeonato`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
